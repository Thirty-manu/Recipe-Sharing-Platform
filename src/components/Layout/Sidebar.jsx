        ...
        <div style={{ padding: "12px 8px", borderTop: "1px solid var(--border)" }}>
          <div style={{ display: "flex", alignItems: "center", gap: 10, padding: "8px 10px", borderRadius: 8 }}>
            <div style={{ position: "relative" }}>
              ...
              {admin && <div style={{ position: "absolute", bottom: -2, right: -2, width: 14, height: 14, background: "var(--accent)", borderRadius: "50%", display: "flex", alignItems: "center", justifyContent: "center", border: "2px solid var(--bg-sidebar)" }}><Shield size={7} color="#fff" /></div>}
            </div>
